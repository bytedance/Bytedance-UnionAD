...
Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://sf3-fe-tos.pglstatp-toutiao.com/obj/csj-sdk-static/Public/SDK/7.8.0.2/SDK.zip" }
  s.platform         = :ios, "11.0"
  s.frameworks       = 'UIKit', 'MapKit', 'WebKit', 'MediaPlayer', 'CoreLocation', 'AdSupport', 'CoreMedia', 'AVFoundation', 'CoreTelephony', 'StoreKit', 'SystemConfiguration', 'MobileCoreServices', 'CoreMotion', 'Accelerate','AudioToolbox','JavaScriptCore','Security','CoreImage','AudioToolbox','ImageIO','QuartzCore','CoreGraphics','CoreText','SpriteKit'
  ...
  s.subspec 'CSJMediation' do |ss|
    ss.dependency 'Ads-CN-Beta/CSJMediation-Only'
    ss.dependency 'Ads-CN-Beta/BUAdLive-Framework'
  end

  s.subspec 'CSJMediation-Lib' do |ss|
    ss.dependency 'Ads-CN-Beta/CSJMediation-Only'
    ss.dependency 'Ads-CN-Beta/BUAdLive-Lib'
  end
  ...
  s.subspec 'BUAdLive-Lib' do |ss|
    ss.dependency 'Ads-CN-Beta/BUAdLive'
