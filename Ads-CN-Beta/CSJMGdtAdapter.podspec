Pod::Spec.new do |spec|
  ...
  spec.source       = { :http => "https://sf3-fe-tos.pglstatp-toutiao.com/obj/csj-sdk-static/Public/CSJMGdtAdapter/4.15.10.0/CSJMGdtAdapter.zip" }
  ...
  spec.dependency 'Ads-Fusion-CN-Beta/CSJMediation','>= 6.4.1.7'
