Pod::Spec.new do |spec|
  ...
  spec.source       = { :http => "https://sf3-fe-tos.pglstatp-toutiao.com/obj/csj-sdk-static/Public/CSJMKsAdapter/3.3.69.2/CSJMKsAdapter.zip" }
  ...
  spec.dependency 'Ads-Fusion-CN-Beta/CSJMediation','>= 6.5.1.1'
