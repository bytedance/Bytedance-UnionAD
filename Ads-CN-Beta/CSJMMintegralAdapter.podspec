Pod::Spec.new do |spec|
  ...
  spec.source       = { :http => "https://sf3-fe-tos.pglstatp-toutiao.com/obj/csj-sdk-static/Public/CSJMMintegralAdapter/7.7.3.0/CSJMMintegralAdapter.zip" }
  ...
  spec.dependency 'Ads-Fusion-CN-Beta/CSJMediation','>= 6.6.1.0'
