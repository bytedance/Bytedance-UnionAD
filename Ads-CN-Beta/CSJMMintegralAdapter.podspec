Pod::Spec.new do |spec|
  ...
  spec.source       = { :http => "https://sf3-fe-tos.pglstatp-toutiao.com/obj/csj-sdk-static/Public/CSJMMintegralAdapter/7.6.4.0/CSJMMintegralAdapter.zip" }
  ...
  spec.dependency 'Ads-Fusion-CN-Beta/CSJMediation','>= 6.1.2.8'
