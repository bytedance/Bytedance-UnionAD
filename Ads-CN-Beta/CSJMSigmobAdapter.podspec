Pod::Spec.new do |spec|
  ...
  spec.source       = { :http => "https://sf3-fe-tos.pglstatp-toutiao.com/obj/csj-sdk-static/Public/CSJMSigmobAdapter/4.15.3.0/CSJMSigmobAdapter.zip" }
