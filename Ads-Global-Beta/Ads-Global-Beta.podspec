...
Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/#{s.version}/SDK.zip", :sha256 => "813d36decde63aed613ada19c6a713d11053ac25e03b448901c8ee2fe75eb1ce" }
  s.platform         = :ios, "12.0"
