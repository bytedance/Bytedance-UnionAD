...
Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/7.9.0.3/SDK.zip", :sha256 => "d699c61902c75b2bd8d279a22b1ddfa8ebcfe26e32441e55f8d55cea3528ca2c" }
  s.platform         = :ios, "12.0"
