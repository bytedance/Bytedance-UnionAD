...
Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/#{s.version}/SDK.zip", :sha256 => "74718998118ba7e1bc3f5ce5fcfecbb6162bd8ef56d1634d58d152cf23dc150b" }
  s.platform         = :ios, "12.0"
