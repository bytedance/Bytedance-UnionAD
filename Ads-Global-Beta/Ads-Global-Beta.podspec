...
Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/7.9.0.0/SDK.zip", :sha256 => "7295f61b2fd8ad769b5bd52556510d8a018c2a0080c10b3c9bad1fdbba38f7ca" }
  s.platform         = :ios, "12.0"
