...
Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/8.2.0.0/SDK.zip", :sha256 => "a0547d8eb52dca0ea35ee508939110d29073d7683f9ea84a25c4f35c9e6c8685" }
  s.platform         = :ios, "12.0"
