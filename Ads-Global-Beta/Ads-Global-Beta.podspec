...
Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/8.2.0.1/SDK.zip", :sha256 => "7ced2a313eac69cff90527e0b1cee110d2fb32fa7e211cb919187f335fbcc733" }
  s.platform         = :ios, "12.0"
