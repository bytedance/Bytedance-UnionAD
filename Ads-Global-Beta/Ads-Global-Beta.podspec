...
Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/7.9.0.2/SDK.zip", :sha256 => "b6ea138893a182d711bd368b027427f39e7e989ee22cdd1c439d8c1667cb9bfd" }
  s.platform         = :ios, "12.0"
