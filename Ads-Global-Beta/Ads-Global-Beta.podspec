...
Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/7.8.5.1/SDK.zip", :sha256 => "4442dd83c8e1da16c6af9a4110e35bb4b382f32c2af7183c028e4b3360c51a4d" }
  s.platform         = :ios, "12.0"
