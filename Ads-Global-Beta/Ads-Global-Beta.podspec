...
Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/#{s.version}/SDK.zip", :sha256 => "787d1aba3d49f06cf0b7b26c10d5a8787da6b1aa0fb3a4e29e8f09b44014b343" }
  s.platform         = :ios, "12.0"
