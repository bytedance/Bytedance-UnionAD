...
Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/8.0.0.0/SDK.zip", :sha256 => "d8eef704cf7a00ac398e3e5b1e133a977a4d78235292667f1f2fdda1e76fc854" }
  s.platform         = :ios, "12.0"
