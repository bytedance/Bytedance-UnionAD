...
Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/#{s.version}/SDK.zip", :sha256 => "de1a7e0b24c0ecb7f877147e6aebbea72a8f073f37a06463508953c46edc4d33" }
  s.platform         = :ios, "12.0"
