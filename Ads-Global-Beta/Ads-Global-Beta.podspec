...
Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/7.8.5.3/SDK.zip", :sha256 => "1bd5ed2c9db115dd4cd3a5becd473b280f9552a71b8893ab695e790bdd9d2165" }
  s.platform         = :ios, "12.0"
