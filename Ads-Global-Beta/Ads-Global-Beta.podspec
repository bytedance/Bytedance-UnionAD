...
Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/8.0.0.2/SDK.zip", :sha256 => "950d917935663d9a850060814d5c17d9bb557011affcf3776ff4175c13ce46fe" }
  s.platform         = :ios, "12.0"
