...
Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/#{s.version}/SDK.zip", :sha256 => "e26e22416a55ec07c6d0923a347012fbfcba5ab549b75b56e0db9529143f65cb" }
  s.platform         = :ios, "12.0"
