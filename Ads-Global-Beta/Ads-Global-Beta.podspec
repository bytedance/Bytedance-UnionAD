...
Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/8.2.0.6/SDK.zip", :sha256 => "c91fa9e3035c3617ff38a172e2446728b515568bb078d50b7ead635096d88bbe" }
  s.platform         = :ios, "12.0"
