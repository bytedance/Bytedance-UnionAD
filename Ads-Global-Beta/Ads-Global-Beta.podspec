...
Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/8.0.0.1/SDK.zip", :sha256 => "309b596a7bea0d30bfa827b8e4abe1406681e69edddbdb5b7bc92b092575fe61" }
  s.platform         = :ios, "12.0"
