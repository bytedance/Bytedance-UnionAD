...
Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/8.4.0.2/SDK.zip", :sha256 => "07f11696cde027c6ec9095c8b58e6e9261098be66fbd003051286556c184c8b6" }
  s.platform         = :ios, "12.0"
