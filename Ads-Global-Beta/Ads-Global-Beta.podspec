...
Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/#{s.version}/SDK.zip", :sha256 => "0a9be95b7cad84dd5162876ead3943e785c48f74ec8e62a583d2a55d36a1ba40" }
  s.platform         = :ios, "12.0"
