...
Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/8.2.0.2/SDK.zip", :sha256 => "7ad1238ed2911dd2700323a1a00f65588e4c672d62dbcd1079037f50a9e4362b" }
  s.platform         = :ios, "12.0"
