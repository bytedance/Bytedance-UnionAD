...
Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/#{s.version}/SDK.zip", :sha256 => "e7d38f6f090c0db57d9e69ac0177cca51b3630b5d3dfe7c260e5a991f3fd7fda" }
  s.platform         = :ios, "12.0"
