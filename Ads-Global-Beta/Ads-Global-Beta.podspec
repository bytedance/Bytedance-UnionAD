...
Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/#{s.version}/SDK.zip", :sha256 => "d8823c49ddc44aa810aa1cea9b53f09e65f74af788e1b2dea6e433e2b9e3304f" }
  s.platform         = :ios, "12.0"
