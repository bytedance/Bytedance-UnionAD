...
Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/8.2.0.3/SDK.zip", :sha256 => "e4e62e4052d7fa5869355a3927367918213d26956a9ccc94c0f5793e80df3a3f" }
  s.platform         = :ios, "12.0"
