...
Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/8.2.0.4/SDK.zip", :sha256 => "a0d861937552544845f028989a51abc560f1af9c676c0b88677b5311a18ccbfe" }
  s.platform         = :ios, "12.0"
