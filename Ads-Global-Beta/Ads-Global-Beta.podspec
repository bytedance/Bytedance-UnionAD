...
Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/8.3.0.0/SDK.zip", :sha256 => "4755557e91fd22d23fb1ad2f420ac955cdda4f4f510b3a9e43c63d97d41bca0f" }
  s.platform         = :ios, "12.0"
