...
Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/8.0.0.3/SDK.zip", :sha256 => "7e478718f6ae534222359730aa20d681d9540e7d80e457ecc78cb7ddcb9ff6cf" }
  s.platform         = :ios, "12.0"
