...
Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/8.1.0.3/SDK.zip", :sha256 => "ad50509ca57d419d8eb18bc26034da2ab89f3651ce46d57cb502ab97e4a90e1a" }
  s.platform         = :ios, "12.0"
