...
Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/#{s.version}/SDK.zip", :sha256 => "b37ffdc184aeb8e0efd1d0bf4af555b8d032ce18ef39695d949a45bdd10f97ec" }
  s.platform         = :ios, "12.0"
