...
Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/8.3.0.3/SDK.zip", :sha256 => "16d5aa6a71580cde1b4d3de48add3d4f000c7c2d3b1de15497642e4c3b71806b" }
  s.platform         = :ios, "12.0"
