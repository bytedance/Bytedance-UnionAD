...
Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/8.2.0.5/SDK.zip", :sha256 => "5a4d4ec02e509cf91dcde73f3dbed3c16a81b07a247da1bfd0efdc6ef87a0730" }
  s.platform         = :ios, "12.0"
