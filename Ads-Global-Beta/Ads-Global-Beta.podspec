...
Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/#{s.version}/SDK.zip", :sha256 => "da21d045a43b95d52aa95cef2a7ed651d2101e06d50f1845d642e549b8b7bd1d" }
  s.platform         = :ios, "12.0"
