...
Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/8.4.0.3/SDK.zip", :sha256 => "75b747bbc6c7e6219e22b05f02a33ae5f846425424fb26a335067ea2b3cc89da" }
  s.platform         = :ios, "12.0"
