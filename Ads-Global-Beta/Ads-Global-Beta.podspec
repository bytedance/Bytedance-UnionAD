...
Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/8.1.0.5/SDK.zip", :sha256 => "eb767b74f813a11560a7b2fac3524cb396ca1c2a0dcf1ee25d6863585ced67b4" }
  s.platform         = :ios, "12.0"
