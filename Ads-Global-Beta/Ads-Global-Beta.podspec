...
Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/7.8.5.0/SDK.zip", :sha256 => "0118d225f2c19a4665c985e77b92f27b8e60b39c31896cfdacc9753c4979ba42" }
  s.platform         = :ios, "12.0"
