...
Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/7.8.0.1/SDK.zip", :sha256 => "cc0b1de8a08d5ad862c5bbc6128052e49267f063741298792464c26f6089e2bf" }
  s.platform         = :ios, "12.0"
