...
Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/8.0.0.5/SDK.zip", :sha256 => "5524f8cf33a88379a5a54dbe3313aa50053191e9ed565824a98e46e45956c462" }
  s.platform         = :ios, "12.0"
