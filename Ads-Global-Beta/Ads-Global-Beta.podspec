...
Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/#{s.version}/SDK.zip", :sha256 => "59958c2080a8a362b8af4a154ea787ed876e99838c0eddf10f44b80c276080a2" }
  s.platform         = :ios, "12.0"
