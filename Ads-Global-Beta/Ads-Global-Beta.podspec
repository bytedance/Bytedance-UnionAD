...
Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/7.7.0.1/SDK.zip", :sha256 => "9cdd3ace4e6a070c7fd2408cf31e0e2f190e5deb710f64859175ffe24d8d5826" }
  s.platform         = :ios, "12.0"
