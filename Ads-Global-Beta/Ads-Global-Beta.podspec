...
Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/8.1.0.1/SDK.zip", :sha256 => "59fb3297fbd855fa332a2c06019c6a8f01f38927f2535678b87c69eeabb05e2a" }
  s.platform         = :ios, "12.0"
