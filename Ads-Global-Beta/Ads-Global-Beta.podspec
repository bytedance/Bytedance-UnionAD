...
Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/7.9.0.1/SDK.zip", :sha256 => "baa8f54e5aee0bbff1ab01e743b673fb528505013a5b6c5fb650ae0cc5511b8c" }
  s.platform         = :ios, "12.0"
