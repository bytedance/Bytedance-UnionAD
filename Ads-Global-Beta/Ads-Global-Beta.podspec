...
Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/8.0.0.4/SDK.zip", :sha256 => "beec1777383f2d790f01b3123ecd0c311ea6c415e45b907c66418b6d2a268d25" }
  s.platform         = :ios, "12.0"
