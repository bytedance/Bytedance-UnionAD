...
Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/#{s.version}/SDK.zip", :sha256 => "e54fc9286e57005db7b64213dfaf594bd5eca3aa40e4a206c0739550b71f6f48" }
  s.platform         = :ios, "12.0"
