...
Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/#{s.version}/SDK.zip", :sha256 => "82c492d743866d0f8bc6d024619d5adc8fb9879a5cd3e89a752bfcfb9f50a571" }
  s.platform         = :ios, "12.0"
