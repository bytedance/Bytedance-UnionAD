...
Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/#{s.version}/SDK.zip", :sha256 => "8be22d32974ea8cc27b32d8718de53557eef68522614fd55790cedabd3d4521a" }
  s.platform         = :ios, "12.0"
