...
Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/#{s.version}/SDK.zip", :sha256 => "fc3709db82fec077f1d99375609fe8d103b94c55772e0e270657a8d6e5199605" }
  s.platform         = :ios, "12.0"
