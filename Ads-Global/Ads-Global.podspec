...
Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/7.6.0.9/SDK.zip", :sha256 => "88cd6fe68a237bcb22c2dd28c546945794fc5c339fcfbc80379c490c1e16e46c" }
  s.platform         = :ios, "12.0"
