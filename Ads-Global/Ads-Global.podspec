...
Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/7.9.1.2/SDK.zip", :sha256 => "e5097f095f1a34edfd23b5b3db4bbd6dd93bd731366d50d6a0b0a6dd7a1c2955" }
  s.platform         = :ios, "12.0"
