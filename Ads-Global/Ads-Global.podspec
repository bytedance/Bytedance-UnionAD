...
Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/8.2.1.1/SDK.zip", :sha256 => "c4ed3cf62b7f0185bebec6e0e2d80070a989003760a105c32e70332179f3fa72" }
  s.platform         = :ios, "12.0"
