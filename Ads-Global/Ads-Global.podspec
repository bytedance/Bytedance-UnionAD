...
Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/7.8.5.5/SDK.zip", :sha256 => "a1b5693bae51902987e806e293fbe32af3372483dcf018869b338e75a5aea54d" }
  s.platform         = :ios, "12.0"
