...
Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/8.2.0.7/SDK.zip", :sha256 => "fe03a669a80f512cb64ecc001cab4e53bf90cbc28f7a8c84958e922a77129774" }
  s.platform         = :ios, "12.0"
