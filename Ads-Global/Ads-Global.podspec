...
Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/#{s.version}/SDK.zip", :sha256 => "10aa36851b51bdcf5e67e92aa21bd1f7caef9ceff8b70b2916333b6e2d2cbed3" }
  s.platform         = :ios, "12.0"
