...
Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/8.2.0.8/SDK.zip", :sha256 => "fcc200cd1d128a0e460dea33649b6b7c6b2aeb70b1e617ce5d61ab71d6528b23" }
  s.platform         = :ios, "12.0"
