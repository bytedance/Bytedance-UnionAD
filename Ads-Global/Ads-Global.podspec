...
Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/8.0.1.0/SDK.zip", :sha256 => "5b094c6a6d7f4e27abc81450ede900ba6c45f8453468a07f53775471080bb196" }
  s.platform         = :ios, "12.0"
