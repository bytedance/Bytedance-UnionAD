...
Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/7.7.0.8/SDK.zip", :sha256 => "22c107de2b87d3be987f55a9a9d10b42a9caedb5b6ec640a53fbf8ef6fa92c5e" }
  s.platform         = :ios, "12.0"
