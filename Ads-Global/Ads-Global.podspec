...
Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/8.1.0.9/SDK.zip", :sha256 => "b8c8ae971f7b410524c94f1ec0989726714a8847784a083a71c1fb8a55a26ebb" }
  s.platform         = :ios, "12.0"
