...
Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/8.0.0.7/SDK.zip", :sha256 => "5a044500988c12fe9e4d09d6a1aac1b1d0ffe5bebcf97a75be073ec039f79134" }
  s.platform         = :ios, "12.0"
