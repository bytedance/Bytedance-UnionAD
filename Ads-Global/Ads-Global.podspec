...
Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/7.8.0.8/SDK.zip", :sha256 => "b0574de27fe8dfc67323d94431315cf9766bcd1e96d47bb5cd86c5e864d92697" }
  s.platform         = :ios, "12.0"
