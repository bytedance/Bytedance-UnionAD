...
Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/7.9.0.6/SDK.zip", :sha256 => "f9b4c1f29d5b5b1c31ec06e58cda04937e320ad1690589301c3116bdb71a6e7f" }
  s.platform         = :ios, "12.0"
