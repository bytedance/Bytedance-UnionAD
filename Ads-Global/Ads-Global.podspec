...
Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/7.9.1.1/SDK.zip", :sha256 => "dc20c5117f04cc8d7509e20d57b6e2df5673fed7f537027b540b629d9aa3d201" }
  s.platform         = :ios, "12.0"
