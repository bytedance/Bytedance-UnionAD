...
Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/8.2.1.0/SDK.zip", :sha256 => "e01b49db6a60c172115978d4773a464fff38062b128a317cef9a9e76360125f8" }
  s.platform         = :ios, "12.0"
