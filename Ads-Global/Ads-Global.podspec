...
Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/7.8.5.7/SDK.zip", :sha256 => "c9c228fa8c1749ba9076d5b0afd02948b0fc3b8cd7e99ec1a40aa5496e0c0f09" }
  s.platform         = :ios, "12.0"
