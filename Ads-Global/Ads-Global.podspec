...
Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/8.1.1.2/SDK.zip", :sha256 => "06d2276fc419e6e0db1d4f15f6dd1c581e22933c88b187d6f267608ba3dc5056" }
  s.platform         = :ios, "12.0"
