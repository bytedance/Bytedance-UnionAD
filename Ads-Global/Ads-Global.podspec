...
Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/#{s.version}/SDK.zip", :sha256 => "2d3c8b3eb9fb234a1064133c3dd2dc04aa9302b4ea6fbe2ae8b07a6e509e1c49" }
  s.platform         = :ios, "12.0"
