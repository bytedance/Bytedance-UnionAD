...
Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/7.7.0.9/SDK.zip", :sha256 => "cc9676ed2a519ba1811bd8f46985f7d3caddb46f48769c2f8d241c84a62093aa" }
  s.platform         = :ios, "12.0"
