...
Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/#{s.version}/SDK.zip", :sha256 => "ab1e5444c7c3598a88cac91c84639cae2bac47679ef70f0f247fc9f3a1cc7338" }
  s.platform         = :ios, "12.0"
