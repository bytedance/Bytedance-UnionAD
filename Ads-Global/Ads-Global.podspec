...
Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/#{s.version}/SDK.zip", :sha256 => "55b6b27d93390cf508ffed74f92d52be1f6bceb31b85ac183310d57876dd3056" }
  s.platform         = :ios, "12.0"
