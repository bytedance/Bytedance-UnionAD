...
Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/8.0.1.2/SDK.zip", :sha256 => "c9ac9cdc291a70e41e2fd5da1c61449624d84338d06df086dae4e865e0e5bc4b" }
  s.platform         = :ios, "12.0"
