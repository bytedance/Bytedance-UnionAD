...
Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/8.1.1.3/SDK.zip", :sha256 => "ed622f96ade455976ed97254f07d5931212f81780aa108eb034770c87a848fd3" }
  s.platform         = :ios, "12.0"
