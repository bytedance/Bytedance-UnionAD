...
Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/7.8.0.3/SDK.zip", :sha256 => "b984481bb86f73a8ba99b96bc0b3c45a961a2c76407f59ba2f13effe93e6edc0" }
  s.platform         = :ios, "12.0"
