...
Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/7.8.0.6/SDK.zip", :sha256 => "4ffe17f573c12665a891c2b0556e3488d3894372a68ba33b1b858b285b744da1" }
  s.platform         = :ios, "12.0"
