...
Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/8.1.1.1/SDK.zip", :sha256 => "6b480421e77398e059705d14ce424f2de177b8bdab35763e7cc5558dac751a43" }
  s.platform         = :ios, "12.0"
