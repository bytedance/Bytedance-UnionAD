...
Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/8.1.0.7/SDK.zip", :sha256 => "99e6567c516f85f9d87e46681ca9ac75263ae6f6953cd00dd5e09ee3c6ea3019" }
  s.platform         = :ios, "12.0"
