...
Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/#{s.version}/SDK.zip", :sha256 => "38dbab82cf5cd2b47834dd97c021fa0bf4c5a4db5ac73d4c7cded128b7e61d28" }
  s.platform         = :ios, "12.0"
