...
Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/8.2.0.9/SDK.zip", :sha256 => "50cbe4b03742f92e1654f88387e45c227f8b5663460cf87a50a7b57ebbc197e0" }
  s.platform         = :ios, "12.0"
