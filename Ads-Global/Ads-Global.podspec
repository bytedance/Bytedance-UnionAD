...
Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/8.1.0.6/SDK.zip", :sha256 => "9609ce96782e6c6c6b4e4c0d9e816033d076d1b462ee195bce9d84bafee7d307" }
  s.platform         = :ios, "12.0"
