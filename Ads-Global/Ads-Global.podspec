...
Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/7.8.5.6/SDK.zip", :sha256 => "7b5868c0947d2344bbe05922f4d44fdf038fecc0e69c78ae0d0d64a5c8256757" }
  s.platform         = :ios, "12.0"
