...
Pod::Spec.new do |s|
  ...
  s.platform         = :ios, "9.0"
  s.frameworks = 'UIKit', 'WebKit', 'MediaPlayer', 'AdSupport', 'CoreMedia', 'AVFoundation', 'CoreTelephony', 'StoreKit', 'SystemConfiguration', 'MobileCoreServices', 'Accelerate','AudioToolbox','JavaScriptCore','Security','CoreImage','AudioToolbox','ImageIO','QuartzCore','CoreGraphics','CoreText'
  ...
  s.subspec 'Dep_Accurate' do |ss|
    ss.dependency 'BURelyFoundation_Global/Pangle', '0.1.3.2'
  end
