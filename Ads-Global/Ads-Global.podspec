...
Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/#{s.version}/SDK.zip", :sha256 => "68c77a965d1e2f3df029f0d5b3eaec20e2ef74eaa9b38eded960118c645a42f4" }
  s.platform         = :ios, "12.0"
