...
Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/8.0.0.8/SDK.zip", :sha256 => "d2e1a07e4c51ece62e37500811860bdd9052c6630bd09697a317d62b990e78a8" }
  s.platform         = :ios, "12.0"
