...
Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/7.8.0.7/SDK.zip", :sha256 => "a67dffa9aaf3820d96e108333363ab9c909669504e954df1b2c787ff663cfa48" }
  s.platform         = :ios, "12.0"
