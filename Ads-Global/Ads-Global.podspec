...
Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/8.0.1.1/SDK.zip", :sha256 => "6e6d9967d4b6b418260f63a2f0d5822c12a5fef101017e378ce75da938cf82cc" }
  s.platform         = :ios, "12.0"
