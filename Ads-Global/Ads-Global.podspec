...
Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/8.0.0.6/SDK.zip", :sha256 => "3078a25bf482d8eb065820a869a75287860ee114f0ee19320acc3e9c6dc90c3c" }
  s.platform         = :ios, "12.0"
