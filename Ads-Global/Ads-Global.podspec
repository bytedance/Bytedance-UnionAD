...
Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/#{s.version}/SDK.zip", :sha256 => "d0ca4ed2be3a06c02c5ee700403630f70971d8fbea2a11f1c8a9ff7307d0d25f" }
  s.platform         = :ios, "12.0"
