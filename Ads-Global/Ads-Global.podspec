...
Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/7.6.0.4/SDK.zip", :sha256 => "dbf4550981850fd7c0d0c7b187ba9387292384d10fcc2b0e89abec236a29a3a7" }
  s.platform         = :ios, "12.0"
