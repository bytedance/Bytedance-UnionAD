...
Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/8.1.0.8/SDK.zip", :sha256 => "fd5f25b6a0e1dc022d0a5f343dd35790602a3cbf76076f3e65d8397cf0266b6d" }
  s.platform         = :ios, "12.0"
