...
Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/#{s.version}/SDK.zip", :sha256 => "bf5a15b69562991090ea0a33b9e252c450ef3037e0f352f190a4cfde054b6565" }
  s.platform         = :ios, "12.0"
