...
Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/#{s.version}/SDK.zip", :sha256 => "25827a8b908ddeccd2cbeb32b7f45be3f6bdc9db800fb4c6a908c534ac6b5a06" }
  s.platform         = :ios, "12.0"
