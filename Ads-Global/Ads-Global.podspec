...
Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/7.9.0.8/SDK.zip", :sha256 => "ce23a41c129bf2063e4d4ffc9114b5112167ca7b7f14532cc8f7254da764df4d" }
  s.platform         = :ios, "12.0"
