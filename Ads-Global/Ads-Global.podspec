...
Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://sf16-fe-tos-sg.i18n-pglstatp.com/obj/pangle-sdk-static-va/7.7.0.7/SDK.zip", :sha256 => "dbed1839bc3d35f387000f14871cc9235338787db79ea2be8f908bd773b8ca1a" }
  s.platform         = :ios, "12.0"
