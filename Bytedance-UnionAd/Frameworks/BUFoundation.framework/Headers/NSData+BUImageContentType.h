 ...
 */
+ (SDImageFormat)sdBu_imageFormatForImageData:(nullable NSData *)data;
 ...
 */
+ (nonnull CFStringRef)sdBu_UTTypeFromImageFormat:(SDImageFormat)format CF_RETURNS_NOT_RETAINED NS_SWIFT_NAME(sdBu_UTType(from:));
 ...
 */
+ (SDImageFormat)sdBu_imageFormatFromUTType:(nonnull CFStringRef)uttype;
