...
/**
 ...
 @return The encoded data. If can't encode, return nil
 */
- (nullable NSData *)sdBu_imageDataAsFormat:(SDImageFormat)imageFormat NS_SWIFT_NAME(sdBu_imageData(as:));
...
/**
 ...
 @return The encoded data. If can't encode, return nil
 */
- (nullable NSData *)sdBu_imageDataAsFormat:(SDImageFormat)imageFormat compressionQuality:(double)compressionQuality NS_SWIFT_NAME(sdBu_imageData(as:compressionQuality:));
...
/**
 ...
 @return The encoded data. If can't encode, return nil
 */
- (nullable NSData *)sdBu_imageDataAsFormat:(SDImageFormat)imageFormat compressionQuality:(double)compressionQuality firstFrameOnly:(BOOL)firstFrameOnly NS_SWIFT_NAME(sdBu_imageData(as:compressionQuality:firstFrameOnly:));
