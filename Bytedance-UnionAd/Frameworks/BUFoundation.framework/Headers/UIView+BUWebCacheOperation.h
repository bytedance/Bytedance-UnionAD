 ...
 */
- (nullable id<SDWebImageOperation>)sdBu_imageLoadOperationForKey:(nullable NSString *)key;
 ...
 */
- (void)sdBu_setImageLoadOperation:(nullable id<SDWebImageOperation>)operation forKey:(nullable NSString *)key;
