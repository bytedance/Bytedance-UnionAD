...
@interface BUMDCustomFullscreenView ()
...
@implementation BUMDCustomFullscreenView

+ (instancetype)fullscreenView {
    BUMDCustomFullscreenView *view = [[BUMDCustomFullscreenView alloc] initWithFrame:[UIScreen mainScreen].bounds];
    [view setupView];
    return view;
}
