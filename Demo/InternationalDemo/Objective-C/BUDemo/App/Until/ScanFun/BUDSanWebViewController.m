...
#if __has_include(<BURelyAdSDK/BUPanguManager.h>)
#import <BURelyAdSDK/BUPanguManager.h>
#endif
...
#if __has_include(<BURelyAdSDK/BUPanguManager.h>)
                [[BUPanguManager shareInstance] fl_connectSocket:bodyDic[@"params"] startCallback:^(BOOL success, NSDictionary * _Nullable response) {
