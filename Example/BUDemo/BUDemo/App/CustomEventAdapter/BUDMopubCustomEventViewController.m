...
- (void)buildItemsData {
    ...
    self.items = @[@[RewardVideo_Item, FullScreenVideo_Item,Banner_Item, Interstitial_Item],@[Express_RewardVideo_Item, Express_FullScreenVideo_Item,Express_Banner_Item, Express_Interstitial_Item]].mutableCopy;
