 ...
 */
@interface BUDMopub_ExpressFullScreenVideoCusEventVC ()<MPInterstitialAdControllerDelegate>
@property (nonatomic, strong) BUDNormalButton *button;
@property (nonatomic, strong) MPInterstitialAdController *interstitial;
@end

@implementation BUDMopub_ExpressFullScreenVideoCusEventVC
...
- (void)loadFullscreenVideo {
    ...
    self.interstitial = [MPInterstitialAdController
                         interstitialAdControllerForAdUnitId:mopub_expressFullscreen_UnitID];
