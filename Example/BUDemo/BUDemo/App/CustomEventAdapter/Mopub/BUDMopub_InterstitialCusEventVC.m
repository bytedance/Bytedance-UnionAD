//
//  BUDMopub_InterstitialCusEventVC.m
//  BUAdSDKDemo
//
 ...
 */
@interface BUDMopub_InterstitialCusEventVC () <MPInterstitialAdControllerDelegate>
@property (nonatomic, strong) BUDNormalButton *button;
@property (nonatomic, strong) MPInterstitialAdController *interstitial;
@end

@implementation BUDMopub_InterstitialCusEventVC
...
- (void)loadInterstitial {
    ...
    self.interstitial = [MPInterstitialAdController
                         interstitialAdControllerForAdUnitId:mopub_intersttitial_UnitID];
