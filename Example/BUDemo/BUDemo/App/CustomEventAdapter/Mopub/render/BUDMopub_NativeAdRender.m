...
@interface BUDMopub_NativeAdRender ()<MPNativeAdRendererImageHandlerDelegate>

@property (nonatomic, strong) UIView<MPNativeAdRendering> *adView;
@property (nonatomic, strong) BUDMopub_nativeAdAdapter *adapter;
...
@implementation BUDMopub_NativeAdRender
...
+ (MPNativeAdRendererConfiguration *)rendererConfigurationWithRendererSettings:(id<MPNativeAdRendererSettings>)rendererSettings
{
    ...
    config.supportedCustomEvents = @[@"BUDMopub_NativeAdCustomEvent"];
...
{
    if (!adapter || ![adapter isKindOfClass:[BUDMopub_nativeAdAdapter class]]) {
        if (error) {
    ...
    self.adapter = (BUDMopub_nativeAdAdapter *)adapter;
