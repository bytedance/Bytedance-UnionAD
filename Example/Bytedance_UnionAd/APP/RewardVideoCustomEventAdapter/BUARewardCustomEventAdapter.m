...
- (instancetype)initWithRewardBasedVideoAdNetworkConnector:(id<GADMRewardBasedVideoAdNetworkConnector>)connector {
    ...
    if (self) {
        ...
        _adapterDelegate = [[BUARewardCustomEventAdapterDelegate alloc] initWithRewardBasedVideoAdAdapter:self rewardBasedVideoAdconnector:_rewardBasedVideoAdConnector];
    }
    return self;
}
